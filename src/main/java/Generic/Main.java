...
public class Main {
    public static void main(String[] args) {
        ...
        boxDog.setContent("bau bau");
        if (boxDog.getContent() instanceof Dog) {
            Dog dog1 = (Dog) boxDog.getContent();
        }
//  Instanceof -> verifica daca obiectul este de aceasi clasa, return true sau false;
        ...
        String[] names = {"Ana", "Dragos", "Vio"};
        Integer[] numbers = {11, 22, 33};
        Cat[] cats = {new Cat("Tom", 1), new Cat("Miti", 2), new Cat("Pifi", 3)};
        System.out.println();
